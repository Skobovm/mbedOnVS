...
namespace MbedProject
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "MbedProject", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "mbedproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "MbedProject";

        internal const string Language = "MbedProject";
